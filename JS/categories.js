...
const questionRadios = document.querySelectorAll("input[name='questions']");

const previewQuestions = document.getElementById("preview-questions");

questionRadios.forEach((radio) => {
  radio.addEventListener("change", () => {
    previewQuestions.textContent = radio.id.replace("q", "");
  });
});
...
document.querySelector(".start-btn").addEventListener("click", () => {
  const quizSettings = {
    category: previewCategory.textContent,

    difficulty: previewDifficulty.textContent,

    questions: previewQuestions.textContent,
